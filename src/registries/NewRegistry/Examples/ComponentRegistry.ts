...
// export interface ComponentRegistryItemMeta {
// 	hocs: Array<((...params: any[]) => React.ComponentType<any>)>
// 	source: any;
// 	isAsync: boolean;
// 	preload: boolean;
// }
...
// export class ComponentRegistry extends Registry<React.ComponentType<any>, ComponentRegistryItemMeta> {
...
// 		return this.set(name, createComponentRegistryItem({
// 			...existing,
