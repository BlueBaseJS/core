...
var IconCard = function (_React$Component) {
  ...
  _createClass(IconCard, [{
    ...
    value: function render() {
      ...
      var icon = _react2.default.isValidElement(iconProp) ? _react2.default.cloneElement(iconProp, { style: iconStyle }) : _react2.default.createElement(
        Icon,
        null,
        iconProp
      );
      ...
      return onClick ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { style: { width: size, textAlign: 'center', color: textColor, fontSize: parseInt(size.slice(0, -2)) / 8 + 'px' } },
          _react2.default.createElement(
            _Paper2.default,
        ...
        'div',
        { style: { width: size, textAlign: 'center', color: textColor, fontSize: parseInt(size.slice(0, -2)) / 8 + 'px' }, onClick: onClick },
        _react2.default.createElement(
          _Paper2.default,
          { style: iconParent, zDepth: elevation },
          icon
...
IconCard.propTypes = {
  ...
  backgroundColors: _propTypes.PropTypes.array,
