...
var AddPlugin = function (_Plugin) {
    ...
    _createClass(AddPlugin, [{
        ...
        value: function initialize() {
            (0, _Callbacks.addCallback)('plugin.add', function add1(num) {
                return num + 1;
            });
            (0, _Callbacks.addCallback)('plugin.add', function add5(num) {
                return num + 5;
            });
            (0, _Callbacks.addCallback)('plugin.add', function add3(num) {
                return num + 3;
            });
        }
    }]);
...
var SubtractPlugin = function (_Plugin2) {
    ...
    _createClass(SubtractPlugin, [{
        key: 'initialize',
        value: function initialize() {
            (0, _Callbacks.addCallback)('plugin.subtract', function sub1(num) {
                return num - 1;
            });
            (0, _Callbacks.addCallback)('plugin.subtract', function sub2(num) {
                return num - 2;
            });
            (0, _Callbacks.addCallback)('plugin.subtract', function sub3(num) {
                return num - 3;
            });
        }
    }]);
