...
describe('App registry tests', () => {
	...
	describe('Tests for app by extending React Component', () => {
		...
		it('slug should be abc-react-app', () => {
			...
			BR.Apps.set(TestApp);
			expect(BR.Apps.data.has('abc-react-app')).toEqual(true);
			expect(BR.Apps.data.get('abc-react-app').slug).toEqual('abc-react-app');
		});
	...
	describe('Tests for by creating a stateless functional react component', () => {
		...
		it('slug should be hello-stateless-app', () => {
			...
			expect(BR.Apps.data.has('hello-stateless-app')).toEqual(true);
	...
	describe('remove app', () => {
		...
		it('should have App with slug', () => {
			...
			expect(BR.Apps.data.has('hello-react-world')).toEqual(false);
		});
		it('should have Apps', () => {
			BR.Apps.remove('hello-world');
			expect(BR.Apps.data.has('hello-world')).toEqual(false);
			BR.Apps.data = Map();
		});
	});
		...
		it('should initialize all apps', () => {
			...
			class HelloReactApp extends App {
				...
				static initialize(config) {
					BR.Filters.set('test.initialize.hook', function abc() {
						return config + 34;
					});
				}
			}
