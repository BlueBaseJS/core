...
describe('Config registry tests', () => {
	describe('set Config', () => {
		it('should throw error b/c key is undefined', () => {
			expect(() => BR.Configs.set(undefined, 'value')).toThrow('No config key provided');
		});
		it('should throw error b/c key is null', () => {
			expect(() => BR.Configs.set(null, 'value')).toThrow('No config key provided');
		});

		it('should throw error b/c value is undefined', () => {
			expect(() => BR.Configs.set('key', undefined)).toThrow('No config value provided');
		});
		it('should throw error b/c value is null', () => {
			expect(() => BR.Configs.set('key', null)).toThrow('No config value provided');
		});
	...
	describe('get Config', () => {
		it('should throw error b/c key is undefined', () => {
			expect(() => BR.Configs.get(undefined)).toThrow('No config key provided');
		});
		it('should throw error b/c key is null', () => {
